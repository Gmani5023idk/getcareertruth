...
import { Search, Shield, Users, Heart, Clock, ArrowRight, Zap, Sparkles, Menu } from 'lucide-react';
    ...
    <div className="min-h-screen bg-bg">
      ...
      <main className="max-w-7xl mx-auto px-4 py-20">
        <motion.div initial="initial" animate="animate" variants={fadeIn} className="text-center mb-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-text-primary mb-6">For Students</h1>
          ...
          {[
            ...
            <TiltCard key={i} intensity={6} glare={false}>
              <motion.div 
                ...
                className="p-8 bg-surface border border-border rounded-3xl hover:border-accent transition-all h-full"
              >
